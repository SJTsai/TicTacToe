...
public class BestMoveGenerator {
  ...
  public Move getBestMoveForBoardAndCurrentPieceToPlay(TicTacToeBoard board, TicTacToePiece pieceToPlay) {
    this.board = board;
    ...
    return new Move(pieceToPlay, pointForBestMoveRating);
  }
  ...
  private void updateMoveRatingsAndAssociatedMappedPointsForEmptyPoints(List<Point> emptyPoints) {
    for (Point emptyPoint : emptyPoints) {
      Move testMove = new Move(pieceToPlay, emptyPoint);
